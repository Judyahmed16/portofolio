...
import { TypewriterEffectDemo } from "../typewriterEffect/TypewriterEffectDemo";

export default function Mavoid() {
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen overflow-hidden bg-black rounded-md md:h-screen">
      <h2 className="relative z-20 text-6xl font-bold text-center text-white md:text-7xl lg:text-9xl ">
