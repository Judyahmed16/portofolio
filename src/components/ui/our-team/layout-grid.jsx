...
export const LayoutGrid = ({
  ...
  return (
    (<div
      className="relative grid w-full h-[600px] sm:h-[250px] md:h-[900px] max-w-5xl grid-cols-2 gap-4 p-10 mx-auto md:grid-cols-3">
      {cards.map((card, i) => (
...
const ImageComponent = ({
  ...
  return (
    (<motion.img
      ...
      width="500"
      className={cn(
        "object-cover object-top absolute inset-0 transition duration-200 h-[150px] sm:h-[250px] md:h-[450px]"
      )}
      alt="thumbnail" />)
  );
};
